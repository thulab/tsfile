...
TsFile is a columnar storage format designed for time-series data, which supports efficient compression and query. It is very easy to integrate TsFile into your IoT big data processing frameworks.
