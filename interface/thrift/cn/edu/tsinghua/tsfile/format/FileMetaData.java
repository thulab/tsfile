            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  TimeSeries _elem66;
                  _elem66 = new TimeSeries();
                  _elem66.read(iprot);
                  struct.timeseries_list.add(_elem66);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  RowGroupMetaData _elem69;
                  _elem69 = new RowGroupMetaData();
                  _elem69.read(iprot);
                  struct.row_groups.add(_elem69);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i71 = 0; _i71 < _list70.size; ++_i71)
                {
                  ...
                  struct.json_metadata.add(_elem72);
                }
                iprot.readListEnd();
              }
  ...
  private static class FileMetaDataTupleScheme extends TupleScheme<FileMetaData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, FileMetaData struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        {
          TimeSeries _elem87;
          _elem87 = new TimeSeries();
          _elem87.read(iprot);
          struct.timeseries_list.add(_elem87);
        }
      }
      struct.setTimeseries_listIsSet(true);
      struct.max_num_rows = iprot.readI64();
      struct.setMax_num_rowsIsSet(true);
      {
        ...
        {
          RowGroupMetaData _elem90;
          _elem90 = new RowGroupMetaData();
          _elem90.read(iprot);
          struct.row_groups.add(_elem90);
        }
      }
      struct.setRow_groupsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i92 = 0; _i92 < _list91.size; ++_i92)
          {
            ...
            struct.json_metadata.add(_elem93);
          }
        }
        struct.setJson_metadataIsSet(true);
      }
