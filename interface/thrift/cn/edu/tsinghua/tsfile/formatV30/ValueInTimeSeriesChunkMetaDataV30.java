...
public class ValueInTimeSeriesChunkMetaDataV30 implements org.apache.thrift.TBase<ValueInTimeSeriesChunkMetaDataV30, ValueInTimeSeriesChunkMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<ValueInTimeSeriesChunkMetaDataV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new ValueInTimeSeriesChunkMetaDataV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new ValueInTimeSeriesChunkMetaDataV30TupleSchemeFactory());
  }
   ...
   * values in time series
   */
  public ValueInTimeSeriesChunkMetaDataV30 setEnum_values(List<String> enum_values) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ValueInTimeSeriesChunkMetaDataV30(");
    boolean first = true;
  ...
  private static class ValueInTimeSeriesChunkMetaDataV30StandardSchemeFactory implements SchemeFactory {
  ...
  private static class ValueInTimeSeriesChunkMetaDataV30StandardScheme extends StandardScheme<ValueInTimeSeriesChunkMetaDataV30> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.enum_values = new ArrayList<String>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  String _elem18;
                  _elem18 = iprot.readString();
                  struct.enum_values.add(_elem18);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.enum_values != null) {
        if (struct.isSetEnum_values()) {
          oprot.writeFieldBegin(ENUM_VALUES_FIELD_DESC);
          {
            ...
            for (String _iter19 : struct.enum_values)
            {
  ...
  private static class ValueInTimeSeriesChunkMetaDataV30TupleSchemeFactory implements SchemeFactory {
    public ValueInTimeSeriesChunkMetaDataV30TupleScheme getScheme() {
      return new ValueInTimeSeriesChunkMetaDataV30TupleScheme();
    }
  }

  private static class ValueInTimeSeriesChunkMetaDataV30TupleScheme extends TupleScheme<ValueInTimeSeriesChunkMetaDataV30> {
      ...
      if (struct.isSetEnum_values()) {
        {
          ...
          for (String _iter20 : struct.enum_values)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.enum_values = new ArrayList<String>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            String _elem23;
            _elem23 = iprot.readString();
            struct.enum_values.add(_elem23);
          }
        }
        struct.setEnum_valuesIsSet(true);
      }
