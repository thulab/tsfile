...
public class ValueInTimeSeriesChunkMetaDataV30 implements org.apache.thrift.TBase<ValueInTimeSeriesChunkMetaDataV30, ValueInTimeSeriesChunkMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<ValueInTimeSeriesChunkMetaDataV30> {
   ...
   * values in time series
   */
  public ValueInTimeSeriesChunkMetaDataV30 setEnum_values(java.util.List<String> enum_values) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.enum_values = new java.util.ArrayList<String>(_list16.size);
                String _elem17;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.enum_values = new java.util.ArrayList<String>(_list21.size);
          String _elem22;
