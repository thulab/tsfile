...
public class TimeSeriesChunkMetaDataV30 implements org.apache.thrift.TBase<TimeSeriesChunkMetaDataV30, TimeSeriesChunkMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesChunkMetaDataV30> {
   ...
   * Optional json metadata *
   */
  public TimeSeriesChunkMetaDataV30 setJson_metadata(java.util.List<String> json_metadata) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.json_metadata = new java.util.ArrayList<String>(_list27.size);
                String _elem28;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.json_metadata = new java.util.ArrayList<String>(_list37.size);
          String _elem38;
