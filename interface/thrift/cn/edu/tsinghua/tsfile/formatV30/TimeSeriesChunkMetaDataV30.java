...
public class TimeSeriesChunkMetaDataV30 implements org.apache.thrift.TBase<TimeSeriesChunkMetaDataV30, TimeSeriesChunkMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesChunkMetaDataV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new TimeSeriesChunkMetaDataV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new TimeSeriesChunkMetaDataV30TupleSchemeFactory());
  }
   ...
   */
  public List<EncodingV30> encodings; // optional
  /**
  ...
  public TimeSeriesChunkMetaDataV30(TimeSeriesChunkMetaDataV30 other) {
    ...
    if (other.isSetEncodings()) {
      List<EncodingV30> __this__encodings = new ArrayList<EncodingV30>(other.encodings.size());
  ...
  public TimeSeriesChunkMetaDataV30 setMeasurement_uid(String measurement_uid) {
    this.measurement_uid = measurement_uid;
    return this;
  }
  ...
  public void addToEncodings(EncodingV30 elem) {
    if (this.encodings == null) {
      this.encodings = new ArrayList<EncodingV30>();
    }
   ...
   * whether we can decode those pages. *
   */
  public List<EncodingV30> getEncodings() {
   ...
   * whether we can decode those pages. *
   */
  public TimeSeriesChunkMetaDataV30 setEncodings(List<EncodingV30> encodings) {
   ...
   * Optional json metadata *
   */
  public TimeSeriesChunkMetaDataV30 setJson_metadata(List<String> json_metadata) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ENCODINGS:
      if (value == null) {
        ...
        setEncodings((List<EncodingV30>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TimeSeriesChunkMetaDataV30(");
    boolean first = true;
  ...
  private static class TimeSeriesChunkMetaDataV30StandardSchemeFactory implements SchemeFactory {
    public TimeSeriesChunkMetaDataV30StandardScheme getScheme() {
      return new TimeSeriesChunkMetaDataV30StandardScheme();
    }
  }

  private static class TimeSeriesChunkMetaDataV30StandardScheme extends StandardScheme<TimeSeriesChunkMetaDataV30> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TimeSeriesChunkMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TIMESERIES_CHUNK_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.timeseries_chunk_type = TimeSeriesChunkTypeV30.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.encodings = new ArrayList<EncodingV30>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  EncodingV30 _elem26;
                  _elem26 = EncodingV30.findByValue(iprot.readI32());
                  struct.encodings.add(_elem26);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // COMPRESSION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.compression_type = CompressionTypeV30.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.json_metadata = new ArrayList<String>(_list27.size);
                for (int _i28 = 0; _i28 < _list27.size; ++_i28)
                {
                  String _elem29;
                  _elem29 = iprot.readString();
                  struct.json_metadata.add(_elem29);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.json_metadata != null) {
        if (struct.isSetJson_metadata()) {
          oprot.writeFieldBegin(JSON_METADATA_FIELD_DESC);
          {
            ...
            for (String _iter31 : struct.json_metadata)
            {
  ...
  private static class TimeSeriesChunkMetaDataV30TupleSchemeFactory implements SchemeFactory {
    public TimeSeriesChunkMetaDataV30TupleScheme getScheme() {
      return new TimeSeriesChunkMetaDataV30TupleScheme();
    }
  }

  private static class TimeSeriesChunkMetaDataV30TupleScheme extends TupleScheme<TimeSeriesChunkMetaDataV30> {
      ...
      if (struct.isSetJson_metadata()) {
        {
          ...
          for (String _iter33 : struct.json_metadata)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.encodings = new ArrayList<EncodingV30>(_list34.size);
          for (int _i35 = 0; _i35 < _list34.size; ++_i35)
          {
            EncodingV30 _elem36;
            _elem36 = EncodingV30.findByValue(iprot.readI32());
            struct.encodings.add(_elem36);
          }
        }
        struct.setEncodingsIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.json_metadata = new ArrayList<String>(_list37.size);
          for (int _i38 = 0; _i38 < _list37.size; ++_i38)
          {
            String _elem39;
            _elem39 = iprot.readString();
            struct.json_metadata.add(_elem39);
          }
        }
        struct.setJson_metadataIsSet(true);
      }
