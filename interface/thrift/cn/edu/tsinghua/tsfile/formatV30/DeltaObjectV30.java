...
public class DeltaObjectV30 implements org.apache.thrift.TBase<DeltaObjectV30, DeltaObjectV30._Fields>, java.io.Serializable, Cloneable, Comparable<DeltaObjectV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new DeltaObjectV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeltaObjectV30TupleSchemeFactory());
  }
  ...
  private static class DeltaObjectV30StandardSchemeFactory implements SchemeFactory {
    public DeltaObjectV30StandardScheme getScheme() {
      return new DeltaObjectV30StandardScheme();
    }
  }

  private static class DeltaObjectV30StandardScheme extends StandardScheme<DeltaObjectV30> {
  ...
  private static class DeltaObjectV30TupleSchemeFactory implements SchemeFactory {
    public DeltaObjectV30TupleScheme getScheme() {
      return new DeltaObjectV30TupleScheme();
    }
  }

  private static class DeltaObjectV30TupleScheme extends TupleScheme<DeltaObjectV30> {
