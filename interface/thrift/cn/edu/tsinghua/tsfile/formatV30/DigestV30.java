...
public class DigestV30 implements org.apache.thrift.TBase<DigestV30, DigestV30._Fields>, java.io.Serializable, Cloneable, Comparable<DigestV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new DigestV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new DigestV30TupleSchemeFactory());
  }
...
;
  ...
  public DigestV30 setMax(ByteBuffer max) {
    this.max = max;
    return this;
  }
  ...
  public DigestV30 setMin(ByteBuffer min) {
    this.min = min;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DigestV30(");
    boolean first = true;
  ...
  private static class DigestV30StandardSchemeFactory implements SchemeFactory {
    public DigestV30StandardScheme getScheme() {
      return new DigestV30StandardScheme();
    }
  }

  private static class DigestV30StandardScheme extends StandardScheme<DigestV30> {
  ...
  private static class DigestV30TupleSchemeFactory implements SchemeFactory {
    public DigestV30TupleScheme getScheme() {
      return new DigestV30TupleScheme();
    }
  }

  private static class DigestV30TupleScheme extends TupleScheme<DigestV30> {
