...
public class TimeInTimeSeriesChunkMetaDataV30 implements org.apache.thrift.TBase<TimeInTimeSeriesChunkMetaDataV30, TimeInTimeSeriesChunkMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<TimeInTimeSeriesChunkMetaDataV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new TimeInTimeSeriesChunkMetaDataV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new TimeInTimeSeriesChunkMetaDataV30TupleSchemeFactory());
  }
  ...
  public TimeInTimeSeriesChunkMetaDataV30 setFrequencies(List<Integer> frequencies) {
   ...
   * values in time series
   */
  public TimeInTimeSeriesChunkMetaDataV30 setEnum_values(List<String> enum_values) {
  ...
  private static class TimeInTimeSeriesChunkMetaDataV30StandardSchemeFactory implements SchemeFactory {
    public TimeInTimeSeriesChunkMetaDataV30StandardScheme getScheme() {
      return new TimeInTimeSeriesChunkMetaDataV30StandardScheme();
    }
  }

  private static class TimeInTimeSeriesChunkMetaDataV30StandardScheme extends StandardScheme<TimeInTimeSeriesChunkMetaDataV30> {
        ...
        switch (schemeField.id) {
          case 1: // DATA_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.data_type = DataTypeV30.findByValue(iprot.readI32());
  ...
  private static class TimeInTimeSeriesChunkMetaDataV30TupleSchemeFactory implements SchemeFactory {
    public TimeInTimeSeriesChunkMetaDataV30TupleScheme getScheme() {
      return new TimeInTimeSeriesChunkMetaDataV30TupleScheme();
    }
  }

  private static class TimeInTimeSeriesChunkMetaDataV30TupleScheme extends TupleScheme<TimeInTimeSeriesChunkMetaDataV30> {
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i11 = 0; _i11 < _list10.size; ++_i11)
          {
            ...
            struct.frequencies.add(_elem12);
          }
        }
        struct.setFrequenciesIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            ...
            struct.enum_values.add(_elem15);
          }
        }
        struct.setEnum_valuesIsSet(true);
      }
