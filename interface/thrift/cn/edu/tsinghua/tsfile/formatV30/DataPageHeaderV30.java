...
public class DataPageHeaderV30 implements org.apache.thrift.TBase<DataPageHeaderV30, DataPageHeaderV30._Fields>, java.io.Serializable, Cloneable, Comparable<DataPageHeaderV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new DataPageHeaderV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new DataPageHeaderV30TupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DataPageHeaderV30(");
    boolean first = true;
  ...
  private static class DataPageHeaderV30StandardSchemeFactory implements SchemeFactory {
    public DataPageHeaderV30StandardScheme getScheme() {
      return new DataPageHeaderV30StandardScheme();
    }
  }

  private static class DataPageHeaderV30StandardScheme extends StandardScheme<DataPageHeaderV30> {
  ...
  private static class DataPageHeaderV30TupleSchemeFactory implements SchemeFactory {
    public DataPageHeaderV30TupleScheme getScheme() {
      return new DataPageHeaderV30TupleScheme();
    }
  }

  private static class DataPageHeaderV30TupleScheme extends TupleScheme<DataPageHeaderV30> {
