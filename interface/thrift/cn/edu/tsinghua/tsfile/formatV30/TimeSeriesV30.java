...
public class TimeSeriesV30 implements org.apache.thrift.TBase<TimeSeriesV30, TimeSeriesV30._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new TimeSeriesV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new TimeSeriesV30TupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.TYPE_LENGTH,_Fields.FREQ_TYPE,_Fields.FREQUENCIES,_Fields.CONVERTED_TYPE,_Fields.SCALE,_Fields.PRECISION,_Fields.FIELD_ID,_Fields.ENUM_VALUES};
   ...
   * Note that a measurement may have multiple frequency values.
   */
  public TimeSeriesV30 setFrequencies(List<Integer> frequencies) {
   ...
   * values in time series
   */
  public TimeSeriesV30 setEnum_values(List<String> enum_values) {
  ...
  private static class TimeSeriesV30StandardSchemeFactory implements SchemeFactory {
    public TimeSeriesV30StandardScheme getScheme() {
      return new TimeSeriesV30StandardScheme();
    }
  }

  private static class TimeSeriesV30StandardScheme extends StandardScheme<TimeSeriesV30> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = DataTypeV30.findByValue(iprot.readI32());
          ...
          case 4: // FREQ_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.freq_type = FreqTypeV30.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i57 = 0; _i57 < _list56.size; ++_i57)
                {
                  ...
                  struct.frequencies.add(_elem58);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // CONVERTED_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.converted_type = ConvertedTypeV30.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i60 = 0; _i60 < _list59.size; ++_i60)
                {
                  ...
                  struct.enum_values.add(_elem61);
                }
                iprot.readListEnd();
              }
  ...
  private static class TimeSeriesV30TupleSchemeFactory implements SchemeFactory {
    public TimeSeriesV30TupleScheme getScheme() {
      return new TimeSeriesV30TupleScheme();
    }
  }

  private static class TimeSeriesV30TupleScheme extends TupleScheme<TimeSeriesV30> {
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i67 = 0; _i67 < _list66.size; ++_i67)
          {
            ...
            struct.frequencies.add(_elem68);
          }
        }
        struct.setFrequenciesIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          for (int _i70 = 0; _i70 < _list69.size; ++_i70)
          {
            ...
            struct.enum_values.add(_elem71);
          }
        }
        struct.setEnum_valuesIsSet(true);
      }
