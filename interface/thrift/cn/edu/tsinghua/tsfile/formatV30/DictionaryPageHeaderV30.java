...
public class DictionaryPageHeaderV30 implements org.apache.thrift.TBase<DictionaryPageHeaderV30, DictionaryPageHeaderV30._Fields>, java.io.Serializable, Cloneable, Comparable<DictionaryPageHeaderV30> {
  ...
  static {
    schemes.put(StandardScheme.class, new DictionaryPageHeaderV30StandardSchemeFactory());
    schemes.put(TupleScheme.class, new DictionaryPageHeaderV30TupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DictionaryPageHeaderV30(");
    boolean first = true;
  ...
  private static class DictionaryPageHeaderV30StandardSchemeFactory implements SchemeFactory {
    public DictionaryPageHeaderV30StandardScheme getScheme() {
      return new DictionaryPageHeaderV30StandardScheme();
    }
  }

  private static class DictionaryPageHeaderV30StandardScheme extends StandardScheme<DictionaryPageHeaderV30> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DictionaryPageHeaderV30 struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // ENCODING
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.encoding = EncodingV30.findByValue(iprot.readI32());
  ...
  private static class DictionaryPageHeaderV30TupleSchemeFactory implements SchemeFactory {
    public DictionaryPageHeaderV30TupleScheme getScheme() {
      return new DictionaryPageHeaderV30TupleScheme();
    }
  }

  private static class DictionaryPageHeaderV30TupleScheme extends TupleScheme<DictionaryPageHeaderV30> {
