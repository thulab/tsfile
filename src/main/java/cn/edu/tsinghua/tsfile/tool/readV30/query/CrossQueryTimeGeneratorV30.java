 ...
 * @author ZJR, CGF
 */
public abstract class CrossQueryTimeGeneratorV30 {
    ...
    public CrossQueryTimeGeneratorV30(SingleSeriesFilterExpression timeFilter, SingleSeriesFilterExpression freqFilter,
