package cn.edu.tsinghua.tsfile.tool.readV30.query;
 ...
 * @author Jinrui Zhang
 */
public class DynamicOneColumnDataV30 {
    ...
    public cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData insertTrue;
    public cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData updateTrue;
    public cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData updateFalse;
    public SingleSeriesFilterExpression timeFilter;

    public DynamicOneColumnDataV30() {
        dataType = null;
    }

    public DynamicOneColumnDataV30(TSDataType type) {
        dataType = type;
    }
     ...
     */
    public DynamicOneColumnDataV30(TSDataType type, boolean recordTime) {
        init(type, recordTime, false);
    }

    public DynamicOneColumnDataV30(TSDataType type, boolean recordTime, boolean hasEmptyTime) {
     ...
     */
    public void mergeRecord(cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData col) {
    ...
    public void putAValueFromDynamicOneColumnData(cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData B, int idx) {
        switch (dataType) {
            case BOOLEAN:
    ...
    public cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData sub(int startPos) {
     ...
     */
    public cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData sub(int startPos, int endPos) {
        cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData subRes = new cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData(dataType, true);
    ...
    public void putOverflowInfo(cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData insertTrue, cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData updateTrue,
                                cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData updateFalse, SingleSeriesFilterExpression timeFilter) {
    ...
    public void copyFetchInfoTo(cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData oneColRet) {
