...
import cn.edu.tsinghua.tsfile.timeseries.read.query.CrossQueryIteratorDataSet;
import cn.edu.tsinghua.tsfile.timeseries.read.query.CrossQueryTimeGenerator;
import cn.edu.tsinghua.tsfile.timeseries.read.query.DynamicOneColumnData;
import cn.edu.tsinghua.tsfile.timeseries.read.query.IteratorQueryDataSet;
...
public class QueryEngineV30 {
    private static final Logger logger = LoggerFactory.getLogger(cn.edu.tsinghua.tsfile.timeseries.read.query.QueryEngine.class);
    private static int FETCH_SIZE = 20000;
    private RecordReader recordReader;

    public QueryEngineV30(ITsRandomAccessFileReader raf) throws IOException {
        recordReader = new RecordReader(raf);
    }

    public QueryEngineV30(ITsRandomAccessFileReader raf, int fetchSize) throws IOException {
        recordReader = new RecordReader(raf);
    ...
    public static QueryDataSet query(QueryConfig config, String fileName) throws IOException {
        ...
        cn.edu.tsinghua.tsfile.timeseries.read.query.QueryEngine queryEngine = new cn.edu.tsinghua.tsfile.timeseries.read.query.QueryEngine(raf);
