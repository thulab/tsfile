 ...
 * @author Jinrui Zhang
 */
public abstract class BatchReadRecordGeneratorV30 {
    ...
    public BatchReadRecordGeneratorV30(List<Path> paths, int fetchSize) throws ProcessorException, IOException {
        noRetCount = 0;
