 ...
 * @author Jinrui Zhang
 */
public class FileReaderV30 {
    private static final Logger logger = LoggerFactory.getLogger(cn.edu.tsinghua.tsfile.timeseries.read.FileReader.class);
    ...
    public FileReaderV30(ITsRandomAccessFileReader raf) throws IOException {
     ...
     */
    public FileReaderV30(ITsRandomAccessFileReader reader, List<RowGroupMetaData> rowGroupMetaDataList) {
