...
public abstract class IteratorQueryDataSetV30 extends QueryDataSet {
    private static final Logger logger = LoggerFactory.getLogger(cn.edu.tsinghua.tsfile.timeseries.read.query.IteratorQueryDataSet.class);
    public LinkedHashMap<Path, DynamicOneColumnData> retMap;
    private LinkedHashMap<Path, Boolean> hasMoreRet;

    public IteratorQueryDataSetV30(List<Path> paths) throws IOException {
