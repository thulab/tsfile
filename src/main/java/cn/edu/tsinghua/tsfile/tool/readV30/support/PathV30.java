...
public class PathV30 {
    ...
    public boolean equals(Object obj) {
        return obj != null && obj instanceof cn.edu.tsinghua.tsfile.timeseries.read.support.Path && this.fullPath.equals(((cn.edu.tsinghua.tsfile.timeseries.read.support.Path) obj).fullPath);
    }
    ...
    @Override
    public cn.edu.tsinghua.tsfile.timeseries.read.support.Path clone() {
        return new cn.edu.tsinghua.tsfile.timeseries.read.support.Path(fullPath);
    }
     ...
     */
    public boolean startWith(cn.edu.tsinghua.tsfile.timeseries.read.support.Path prefix) {
        return startWith(prefix.fullPath);
    }

    public static cn.edu.tsinghua.tsfile.timeseries.read.support.Path mergePath(cn.edu.tsinghua.tsfile.timeseries.read.support.Path prefix, cn.edu.tsinghua.tsfile.timeseries.read.support.Path suffix) {
        StringContainer sc = new StringContainer(SystemConstant.PATH_SEPARATOR);
        sc.addTail(prefix);
        sc.addTail(suffix);
        return new cn.edu.tsinghua.tsfile.timeseries.read.support.Path(sc);
    }
     ...
     */
    public static cn.edu.tsinghua.tsfile.timeseries.read.support.Path addPrefixPath(cn.edu.tsinghua.tsfile.timeseries.read.support.Path src, String prefix) {
        StringContainer sc = new StringContainer(SystemConstant.PATH_SEPARATOR);
        sc.addTail(prefix);
        sc.addTail(src);
        return new cn.edu.tsinghua.tsfile.timeseries.read.support.Path(sc);
     ...
     */
    public static cn.edu.tsinghua.tsfile.timeseries.read.support.Path addPrefixPath(cn.edu.tsinghua.tsfile.timeseries.read.support.Path src, cn.edu.tsinghua.tsfile.timeseries.read.support.Path prefix) {
     ...
     */
    public static cn.edu.tsinghua.tsfile.timeseries.read.support.Path replace(String srcPrefix, cn.edu.tsinghua.tsfile.timeseries.read.support.Path descPrefix) {
        ...
        if (descArray.length <= prefixSize)
            return new cn.edu.tsinghua.tsfile.timeseries.read.support.Path(srcPrefix);
        StringContainer sc = new StringContainer(SystemConstant.PATH_SEPARATOR);
     ...
     */
    public static cn.edu.tsinghua.tsfile.timeseries.read.support.Path replace(cn.edu.tsinghua.tsfile.timeseries.read.support.Path srcPrefix, cn.edu.tsinghua.tsfile.timeseries.read.support.Path descPrefix) {
