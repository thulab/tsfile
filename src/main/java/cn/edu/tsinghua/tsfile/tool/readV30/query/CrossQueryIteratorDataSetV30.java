 ...
 * @author Jinrui Zhang
 */
public abstract class CrossQueryIteratorDataSetV30 extends QueryDataSet {
    private static final Logger LOG = LoggerFactory.getLogger(cn.edu.tsinghua.tsfile.timeseries.read.query.CrossQueryIteratorDataSet.class);
    //special for save time values when processing cross getIndex
    private boolean hasReadAll;

    public CrossQueryIteratorDataSetV30(CrossQueryTimeGenerator timeGenerator) throws IOException {
