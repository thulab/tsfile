...
/**
 * Define a basic FilterSeries class, which contains deltaObjectUID, measurementUID, seriesDataType
 * and filterType.
 *
 * @author CGF
 */
public abstract class FilterSeries<T extends Comparable<T>> implements Serializable {
  ...
  public String toString() {
    return "FilterSeries (" + deltaObjectUID + "," + measurementUID + "," + seriesDataType + ","
        + filterType + ")";
  }
