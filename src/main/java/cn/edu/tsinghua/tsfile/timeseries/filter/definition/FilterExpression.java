...
/**
 * FilterExpression is a top level filter abstraction. FilterExpression has two types of subclass :
 * {@link SingleSeriesFilterExpression} and {@link CrossSeriesFilterExpression} FilterExpression is
 * a role of interviewee in visitor pattern.
 *
 * @author CGF
 */
