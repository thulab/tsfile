 ...
 * data type. subclass of DataPoint need override method
 * {@code write(long time, ISeriesWriter writer)} .Every subclass has its data type and overrides a
 * setting method for its data type.
 *
 * @author kangrong
 */
