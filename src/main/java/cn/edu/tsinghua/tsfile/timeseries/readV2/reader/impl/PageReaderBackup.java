 ...
 * @author Jinrui Zhang
 */
public class PageReaderBackup implements TimeValuePairReader {
    ...
    public PageReaderBackup(InputStream pageContent, TSDataType dataType, Decoder valueDecoder, Decoder timeDecoder) throws IOException {
