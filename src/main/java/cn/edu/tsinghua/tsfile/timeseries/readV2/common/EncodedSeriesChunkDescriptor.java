...
public class EncodedSeriesChunkDescriptor implements SeriesChunkDescriptor {
  ...
  public EncodedSeriesChunkDescriptor(long offsetInFile, long lengthOfBytes,
      CompressionTypeName compressionTypeName, TSDataType dataType, TsDigest valueDigest,
      long minTimestamp, long maxTimestamp, long countOfPoints) {
  ...
  public EncodedSeriesChunkDescriptor(long offsetInFile, long lengthOfBytes,
      CompressionTypeName compressionTypeName, TSDataType dataType, TsDigest valueDigest,
      long minTimestamp, long maxTimestamp, long countOfPoints, List<String> enumValueList) {
    this(offsetInFile, lengthOfBytes, compressionTypeName, dataType, valueDigest, minTimestamp,
        maxTimestamp, countOfPoints);
    this.enumValueList = enumValueList;
  }

  public EncodedSeriesChunkDescriptor(String filePath, long offsetInFile, long lengthOfBytes,
      CompressionTypeName compressionTypeName, TSDataType dataType, TsDigest valueDigest,
      long minTimestamp, long maxTimestamp, long countOfPoints) {
    this(offsetInFile, lengthOfBytes, compressionTypeName, dataType, valueDigest, minTimestamp,
        maxTimestamp, countOfPoints);
  ...
  public EncodedSeriesChunkDescriptor(String filePath, long offsetInFile, long lengthOfBytes,
      CompressionTypeName compressionTypeName, TSDataType dataType, TsDigest valueDigest,
      long minTimestamp, long maxTimestamp, long countOfPoints, List<String> enumValueList) {
    this(filePath, offsetInFile, lengthOfBytes, compressionTypeName, dataType, valueDigest,
        minTimestamp, maxTimestamp, countOfPoints);
    this.enumValueList = enumValueList;
  }
  ...
  public String toString() {
    return "EncodedSeriesChunkDescriptor{" + "filePath='" + filePath + '\'' + ", offsetInFile="
        + offsetInFile + ", lengthOfBytes=" + lengthOfBytes + ", compressionTypeName="
        + compressionTypeName + ", dataType=" + dataType + ", valueDigest=" + valueDigest
        + ", minTimestamp=" + minTimestamp + ", maxTimestamp=" + maxTimestamp + ", countOfPoints="
        + countOfPoints + ", enumValueList=" + enumValueList + '}';
  }
