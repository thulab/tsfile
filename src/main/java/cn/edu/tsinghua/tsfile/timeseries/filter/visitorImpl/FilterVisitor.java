...
/**
 * FilterVisitor is implemented by visitor pattern. Implemented using visitor pattern.
 *
 * A FilterVistor must visit all these methods below, per visitor design pattern. And a
 * FilterExpression just need implements an accept() method.
 *
 * @author CGF
 */
