...
/**
 * To judge whether an overflow time interval satisfy the filter. Implemented using visitor pattern.
 *
 * @author CGF
 */
public class IntervalTimeVisitor implements FilterVisitor<Boolean> {
  ...
  public Boolean visit(And and) {
    return satisfy(and.getLeft(), startTime, endTime)
        && satisfy(and.getRight(), startTime, endTime);
  }
