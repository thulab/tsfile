 ...
 */
public class QueryExecutorWithGlobalTimeFilterImpl implements QueryExecutor {

    private SeriesChunkLoader seriesChunkLoader;
    private MetadataQuerier metadataQuerier;

    public QueryExecutorWithGlobalTimeFilterImpl(SeriesChunkLoader seriesChunkLoader, MetadataQuerier metadataQuerier) {
    ...
    private void initReadersOfSelectedSeries(LinkedHashMap<Path, SeriesReader> readersOfSelectedSeries,
        ...
        for (Path path : selectedSeries) {
            ...
            SeriesReader seriesReader = new SeriesReaderFromSingleFileWithFilterImpl(seriesChunkLoader, seriesChunkDescriptorList, timeFilter);
