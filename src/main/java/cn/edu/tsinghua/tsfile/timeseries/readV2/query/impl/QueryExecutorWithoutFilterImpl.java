 ...
 */
public class QueryExecutorWithoutFilterImpl implements QueryExecutor {

    private SeriesChunkLoader seriesChunkLoader;
    private MetadataQuerier metadataQuerier;

    public QueryExecutorWithoutFilterImpl(SeriesChunkLoader seriesChunkLoader, MetadataQuerier metadataQuerier) {
