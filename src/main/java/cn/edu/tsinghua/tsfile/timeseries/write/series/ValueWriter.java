...
public class ValueWriter {
  ...
  /**
   * getBytes return data what it has been written in form of
   * <code>ListByteArrayOutputStream</code>.
   *
  ...
  public long estimateMaxMemSize() {
    return timeOut.size() + valueOut.size() + timeEncoder.getMaxByteSize()
