...
public class QueryWithQueryFilterExecutorImpl implements QueryExecutor {
  ...
  public QueryWithQueryFilterExecutorImpl(SeriesChunkLoader seriesChunkLoader,
  ...
  public QueryDataSet execute(QueryExpression queryExpression) throws IOException {
    TimestampGenerator timestampGenerator = new TimestampGeneratorByQueryFilterImpl(
        queryExpression.getQueryFilter(), seriesChunkLoader, metadataQuerier);
  ...
  private void initReadersOfSelectedSeries(
    ...
    for (Path path : selectedSeries) {
      ...
      SeriesReaderFromSingleFileByTimestampImpl seriesReader =
