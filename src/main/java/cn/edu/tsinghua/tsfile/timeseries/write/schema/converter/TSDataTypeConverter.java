...
/**
 * Each subclass of TSDataTypeConverter responds a enumerate value in {@linkplain TSDataType
 * TSDataType}, which stores several configuration related to responding encoding type.<br>
...
public abstract class TSDataTypeConverter {
  ...
  /**
   * for ENUMS, JSON is a method of the initialization. Each ENUMS in json-format schema should have
   * data value parameters. initFromProps gets values from JSON object which would be used latter.
   * If this type has extra parameter to construct, override it.
   *
