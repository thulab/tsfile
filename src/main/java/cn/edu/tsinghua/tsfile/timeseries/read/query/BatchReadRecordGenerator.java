...
public abstract class BatchReadRecordGenerator {
  ...
  public BatchReadRecordGenerator(List<Path> paths, int fetchSize)
  ...
  public abstract DynamicOneColumnData getMoreRecordsForOneColumn(Path p, DynamicOneColumnData res)
      throws ProcessorException, IOException;

  /**
   * Calculate the fetchSize number RowRecords. Invoking this method will remove the top value in
   * heap until the OldRowRecord number reach to fetchSize.
   *
