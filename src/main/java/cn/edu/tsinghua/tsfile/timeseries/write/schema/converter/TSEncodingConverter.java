...
/**
 * Each subclass of TSEncodingConverter responds a enumerate value in {@linkplain TSEncoding
...
public abstract class TSEncodingConverter {
  ...
  /**
   * check the validity of input parameter. If it's valid, return this parameter in its appropriate
   * type.
   *
  ...
  public static class RLE extends TSEncodingConverter {
    ...
    @Override
    /**
     * RLE could specify <b>max_point_number</b> as parameter, which means the maximum decimal
     * digits for float or double data.
     */
    public Object checkParameter(String pmKey, String value) throws MetadataArgsErrorException {
      if (JsonFormatConstant.MAX_POINT_NUMBER.equals(pmKey)) {
        try {
          ...
          throw new MetadataArgsErrorException(
              "paramter " + pmKey + " meets error integer format :" + value);
        }
      } else
        throw new MetadataArgsErrorException("don't need args:{}" + pmKey);
    }
  ...
  public static class TS_2DIFF extends TSEncodingConverter {
    ...
    @Override
    /**
     * TS_2DIFF could specify <b>max_point_number</b> as parameter, which means the maximum decimal
     * digits for float or double data.
     */
    public Object checkParameter(String pmKey, String value) throws MetadataArgsErrorException {
      if (JsonFormatConstant.MAX_POINT_NUMBER.equals(pmKey)) {
