...
public class TimestampGeneratorByQueryFilterImpl implements TimestampGenerator {
  ...
  public TimestampGeneratorByQueryFilterImpl(QueryFilter queryFilter,
      SeriesChunkLoader seriesChunkLoader, MetadataQuerier metadataQuerier) throws IOException {
    this.queryFilter = queryFilter;
    initNode(seriesChunkLoader, metadataQuerier);
  }

  private void initNode(SeriesChunkLoader seriesChunkLoader, MetadataQuerier metadataQuerier)
      throws IOException {
    NodeConstructorForSingleFileImpl nodeConstructorForSingleFile =
        new NodeConstructorForSingleFileImpl(metadataQuerier, seriesChunkLoader);
