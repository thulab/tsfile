...
/**
 * This class define an Object named Path to represent a series in delta system. And in batch read,
 * this definition is also used in query processing. Note that, Path is unmodified after a new
...
public class Path {
  ...
  /**
   * replace prefix of descPrefix with given parameter {@code srcPrefix}. If the level of the path
   * constructed by {@code srcPrefix} is larger than {@code descPrefix}, return {@code
   * srcPrefix} directly.
   *
   * @param srcPrefix the prefix to replace descPrefix
   * @param descPrefix to be replaced
   * @return If the level of the path constructed by {@code srcPrefix} is larger than
   *         {@code descPrefix}, return {@code srcPrefix} directly.
   */
  ...
  /**
   * replace prefix of {@code descPrefix} with given parameter {@code srcPrefix}. If the level of
   * {@code srcPrefix} is larger than {@code descPrefix}, return {@code srcPrefix} directly.
   *
   * @param srcPrefix the prefix to replace descPrefix
   * @param descPrefix to be replaced
   * @return If the level of {@code srcPrefix} is larger than {@code descPrefix}, return
