...
public class JsonConverter {
	...
	public static Map<String, MeasurementDescriptor> converterJsonToMeasurementDescriptors(JSONObject jsonSchema)
		...
		for (int i = 0; i < schemaArray.length(); i++) {
			MeasurementDescriptor mDescriptor=convertJsonToMeasureMentDescriptor(schemaArray.getJSONObject(i));
	...
	public static MeasurementDescriptor convertJsonToMeasureMentDescriptor(JSONObject measurementObj) {
