...
/**
 * The FilterFactory is used to construct FilterSeries, SingleSeriesFilter, and CrossSeriesFilter.
 *
 * @author CGF
 */
public final class FilterFactory {
   ...
   */
  public static BooleanFilterSeries booleanFilterSeries(String deltaObjectUID,
      String measurementUID, FilterSeriesType filterType) {
   ...
   * @return filter
   */
  public static <T extends Comparable<T>, C extends FilterSeries<T>> Eq<T> eq(C filterSeries,
      T value) {
   ...
   */
  public static <T extends Comparable<T>, C extends FilterSeries<T>> LtEq<T> ltEq(C filterSeries,
      T value, Boolean ifEq) {
   ...
   */
  public static <T extends Comparable<T>, C extends FilterSeries<T>> GtEq<T> gtEq(C filterSeries,
      T value, Boolean ifEq) {
   ...
   */
  public static <T extends Comparable<T>, C extends FilterSeries<T>> NotEq<T> noteq(C filterSeries,
      T value) {
   ...
   */
  private static SingleSeriesFilterExpression ssAnd(SingleSeriesFilterExpression left,
      SingleSeriesFilterExpression right) {
   ...
   */
  private static SingleSeriesFilterExpression ssOr(SingleSeriesFilterExpression left,
      SingleSeriesFilterExpression right) {
    // if (left.getFilterSeries().sameSeries(right.getFilterSeries()))
  ...
  /**
   * construct CSAnd(Cross Series Filter And Operators) use FilterExpression left, right;
   *
   * @param left left expression
   * @param right right expression
   * @return and expression
  ...
  /**
   * construct CSOr(Cross Series Filter Or Operators) use FilterExpression left, right;
   *
   * @param left left expression
   * @param right right expression
   * @return or expression
  ...
  public static FilterExpression and(FilterExpression left, FilterExpression right) {
    ...
    if (left instanceof SingleSeriesFilterExpression
        && right instanceof SingleSeriesFilterExpression
        && (((SingleSeriesFilterExpression) left).getFilterSeries()
            .sameSeries(((SingleSeriesFilterExpression) right).getFilterSeries()))) {
      return ssAnd((SingleSeriesFilterExpression) left, (SingleSeriesFilterExpression) right);
    } else {
