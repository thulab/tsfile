...
/**
 * optimizing of filter, transfer SingleSensorFilter to interval comparison see {@link Interval}
 *
 * @author CGF
 */
public abstract class FilterVerifier {
  ...
  public static FilterVerifier create(TSDataType dataType) {
    switch (dataType) {
      ...
      default:
        LOG.error(
            "wrong filter verifier invoke, FilterVerifier only support INT32,INT64,FLOAT and DOUBLE.");
