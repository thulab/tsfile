...
/**
 * Filter is a top level filter abstraction. Filter has two types of implementations :
 * {@link BinaryFilter} and {@link UnaryFilter} Filter is a role of interviewee in visitor pattern.
 *
 * @author CGF
 */
