...
/**
 * This class provides some function to get one FileReader for one path. Maybe in the later version,
 * every FileReader will be managed by this class.
 *
 * @author Jinrui Zhang
 */
public class FileStreamManager {
  ...
  public ITsRandomAccessFileReader getLocalRandomAccessFileReader(String path)
      throws FileNotFoundException {
    return new TsRandomAccessLocalFileReader(path);
  }

  public void closeLocalRandomAccessFileReader(TsRandomAccessLocalFileReader localFileInput)
      throws IOException {
