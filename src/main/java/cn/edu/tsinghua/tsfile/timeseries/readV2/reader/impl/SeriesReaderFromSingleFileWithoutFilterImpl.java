...
public class SeriesReaderFromSingleFileWithoutFilterImpl extends SeriesReaderFromSingleFile {
  ...
  public SeriesReaderFromSingleFileWithoutFilterImpl(SeriesChunkLoader seriesChunkLoader,
  ...
  public SeriesReaderFromSingleFileWithoutFilterImpl(
      ITsRandomAccessFileReader randomAccessFileReader, Path path) throws IOException {
    super(randomAccessFileReader, path);
  }

  public SeriesReaderFromSingleFileWithoutFilterImpl(
      ITsRandomAccessFileReader randomAccessFileReader, SeriesChunkLoader seriesChunkLoader,
      List<EncodedSeriesChunkDescriptor> encodedSeriesChunkDescriptorList) {
  ...
  protected void initSeriesChunkReader(EncodedSeriesChunkDescriptor encodedSeriesChunkDescriptor)
    ...
    this.seriesChunkReader =
        new SeriesChunkReaderWithoutFilterImpl(memSeriesChunk.getSeriesChunkBodyStream(),
