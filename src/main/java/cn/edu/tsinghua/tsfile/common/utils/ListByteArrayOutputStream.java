...
public class ListByteArrayOutputStream {
  ...
  /**
   * Inputs an OutputStream as parameter. Writes the complete contents in <code>list</code> to the
  ...
  /**
   * Creates a new <code>PublicBAOS</code> which specified size is the current total size and write
   * the current contents in <code>list</code> into it.
   *
