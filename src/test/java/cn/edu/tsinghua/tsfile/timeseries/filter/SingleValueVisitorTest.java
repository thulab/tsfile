...
public class SingleValueVisitorTest {
  ...
  private static final SingleValueVisitor<?> int32Vistor =
      SingleValueVisitorFactory.getSingleValueVisitor(TSDataType.INT32);
  ...
  public void andTest() {
    GtEq<Integer> gteq = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 5, true);
  ...
  public void orTest() {
    GtEq<Integer> gteq = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 550, false);
    LtEq<Integer> lteq = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 52, true);
