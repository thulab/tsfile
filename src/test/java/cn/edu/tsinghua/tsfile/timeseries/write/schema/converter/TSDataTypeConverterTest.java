...
public class TSDataTypeConverterTest {
  ...
  private String enum_values_tring = "a" + JsonFormatConstant.ENUM_VALUES_SEPARATOR + "s"
      + JsonFormatConstant.ENUM_VALUES_SEPARATOR + "2" + JsonFormatConstant.ENUM_VALUES_SEPARATOR
      + "d";
  ...
  public void testCheckParameterNoParameter() {
    ...
    try {
      assertEquals(null, TSDataTypeConverter.checkParameter(type, noExists, noExists));
    } catch (Exception e) {
  ...
  public void testCheckParameterRLE() {
    ...
    String[] ret = null;
    try {
      ret = (String[]) TSDataTypeConverter.checkParameter(type, JsonFormatConstant.ENUM_VALUES,
          enum_values_tring);
    ...
    try {
      TSDataTypeConverter.checkParameter(type, JsonFormatConstant.MAX_POINT_NUMBER, errIntStr1);
    } catch (Exception e) {
      assertTrue(e instanceof MetadataArgsErrorException);
    }
  }
