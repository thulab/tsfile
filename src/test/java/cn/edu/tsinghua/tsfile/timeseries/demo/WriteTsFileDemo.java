...
public class WriteTsFileDemo {
	...
	public static void main(String[] args) throws WriteProcessException, IOException {
		...
		tsFileWriter.addMeasurement(new MeasurementSchema("cpu_utility", TSDataType.FLOAT, TSEncoding.TS_2DIFF));
		tsFileWriter.addMeasurement(new MeasurementSchema("memory_utility", TSDataType.FLOAT, TSEncoding.TS_2DIFF));
