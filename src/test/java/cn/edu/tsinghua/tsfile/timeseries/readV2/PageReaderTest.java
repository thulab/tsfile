...
public class PageReaderTest {
  ...
  public void testLong() {
    ...
    LoopWriteReadTest test =
        new LoopWriteReadTest("Test INT64", new LongRleEncoder(EndianType.BIG_ENDIAN),
  ...
  public void testBoolean() {
    LoopWriteReadTest test = new LoopWriteReadTest("Test Boolean",
        new IntRleEncoder(EndianType.BIG_ENDIAN), new IntRleDecoder(EndianType.BIG_ENDIAN),
        TSDataType.BOOLEAN, POINTS_COUNT_IN_ONE_PAGE) {
      @Override
      public Object generateValueByIndex(int i) {
  ...
  public void testInt() {
    LoopWriteReadTest test =
        new LoopWriteReadTest("Test INT32", new IntRleEncoder(EndianType.BIG_ENDIAN),
  ...
  private abstract static class LoopWriteReadTest {
    ...
    public void test() {
      try {
        ...
        System.out.println("TestName: [" + name + "]\n\tTSDataType: " + dataType + "\tRead-Count:"
            + count + "\tTime-used:" + (endTimestamp - startTimestamp) + "ms");
