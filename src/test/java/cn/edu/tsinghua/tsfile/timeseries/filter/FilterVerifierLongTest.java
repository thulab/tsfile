...
public class FilterVerifierLongTest {
  ...
  public void ltEqTest() {
    LtEq<Long> ltEq = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 45L, true);
  ...
  public void andOrTest() {
    ...
    GtEq<Long> gtEq1 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470L, true);
    LtEq<Long> ltEq1 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200L, false);
    And and1 = (And) FilterFactory.and(gtEq1, ltEq1);

    GtEq<Long> gtEq2 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500L, false);
    LtEq<Long> ltEq2 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800L, true);
    And and2 = (And) FilterFactory.and(gtEq2, ltEq2);

    GtEq<Long> gtEq3 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000L, true);
    LtEq<Long> ltEq3 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000L, false);
    ...
    // [400, 500) (600, 800]
    GtEq<Long> gtEq4 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400L, true);
    LtEq<Long> ltEq4 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500L, false);
    And and4 = (And) FilterFactory.and(gtEq4, ltEq4);

    GtEq<Long> gtEq5 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600L, false);
    LtEq<Long> ltEq5 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800L, true);
    ...
    // [600, 800] [400, 500]
    GtEq<Long> gtEq6 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600L, true);
    LtEq<Long> ltEq6 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800L, false);
    And and6 = (And) FilterFactory.and(gtEq6, ltEq6);

    GtEq<Long> gtEq7 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400L, false);
    LtEq<Long> ltEq8 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500L, true);
  ...
  public void andOrBorderTest() {
    ...
    // And Operator
    GtEq<Long> gtEq1 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2L, false);
    LtEq<Long> ltEq1 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2L, false);
    And and1 = (And) FilterFactory.and(gtEq1, ltEq1);
    ...
    gtEq1 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 2L, true);
    ltEq1 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 2L, false);
    ...
    assertEquals(ans.v[0], Long.MIN_VALUE);
    assertEquals(ans.flag[0], true);
    assertEquals(ans.v[1], Long.MAX_VALUE);
    assertEquals(ans.flag[1], true);
    or1 = (Or) FilterFactory.or(ltEq1, gtEq1);
    ans = new LongFilterVerifier().getInterval(or1);
    assertEquals(ans.count, 2);
  ...
  public void notEqTest() {
    NotEq<Long> notEq = FilterFactory.noteq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000L);
  ...
  public void orTest() {
    ...
    GtEq<Long> gtEq_11 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470L, true);
    LtEq<Long> ltEq_11 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200L, false);
    And and1 = (And) FilterFactory.and(gtEq_11, ltEq_11);

    GtEq<Long> gtEq_12 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500L, false);
    LtEq<Long> ltEq_12 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800L, true);
    And and2 = (And) FilterFactory.and(gtEq_12, ltEq_12);

    GtEq<Long> gtEq_13 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000L, true);
    LtEq<Long> ltEq_l3 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000L, false);
    And and3 = (And) FilterFactory.and(gtEq_13, ltEq_l3);

    GtEq<Long> gtEq_14 = FilterFactory.gtEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 100L, true);
    LtEq<Long> ltEq_14 = FilterFactory.ltEq(FilterFactory.longFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 200L, true);
