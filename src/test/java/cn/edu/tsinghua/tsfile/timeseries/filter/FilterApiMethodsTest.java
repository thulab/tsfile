...
public class FilterApiMethodsTest {
  ...
  private static final LongFilterSeries longFilterSeries = FilterFactory
      .longFilterSeries(deltaObjectLONG, measurementLONG, FilterSeriesType.VALUE_FILTER);
  private static final FloatFilterSeries floatFilterSeries = FilterFactory
      .floatFilterSeries(deltaObjectFLOAT, measurementFLOAT, FilterSeriesType.VALUE_FILTER);
  private static final BooleanFilterSeries booleanFilterSeries = FilterFactory
      .booleanFilterSeries(deltaObjectBOOLEAN, measurementBOOLEAN, FilterSeriesType.VALUE_FILTER);
  private static final DoubleFilterSeries doubleFilterSeries = FilterFactory
      .doubleFilterSeries(deltaObjectDOUBLE, measurementDOUBLE, FilterSeriesType.VALUE_FILTER);
