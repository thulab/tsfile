...
public class InvertExpressionVisitorTest {
  ...
  public void testInvertBinaryOperator() {
    ...
    assertEquals(andInvert.toString(),
        "OR: ( FilterSeries (" + deltaObjectINT + "," + measurementINT
            + ",INT32,VALUE_FILTER) > 60," + "FilterSeries (" + deltaObjectINT + ","
            + measurementINT + ",INT32,VALUE_FILTER) <= 30 )");
    ...
    assertEquals(orInvert.toString(),
        "AND: ( FilterSeries (" + deltaObjectINT + "," + measurementINT
            + ",INT32,VALUE_FILTER) != 60," + "FilterSeries (" + deltaObjectINT + ","
            + measurementINT + ",INT32,VALUE_FILTER) <= 60 )");
    ...
    FilterExpression complex =
        FilterFactory.and(eqQ, FilterFactory.and(ltEqQ, FilterFactory.and(gtEqQ, notEqQ)));
