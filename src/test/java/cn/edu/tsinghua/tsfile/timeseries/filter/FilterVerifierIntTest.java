...
public class FilterVerifierIntTest {
  ...
  public void eqTest() {
    Eq<Integer> eq = FilterFactory.eq(FilterFactory.intFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 45);
  ...
  public void ltEqTest() {
    LtEq<Integer> ltEq = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 45, true);
  ...
  public void andOrTest() {
    ...
    GtEq<Integer> gtEq1 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470, true);
    LtEq<Integer> ltEq1 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200, false);
    And and1 = (And) FilterFactory.and(gtEq1, ltEq1);

    GtEq<Integer> gtEq2 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500, false);
    LtEq<Integer> ltEq2 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    And and2 = (And) FilterFactory.and(gtEq2, ltEq2);

    GtEq<Integer> gtEq3 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000, true);
    LtEq<Integer> ltEq3 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000, false);
    ...
    // [400, 500) (600, 800]
    GtEq<Integer> gtEq4 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400, true);
    LtEq<Integer> ltEq4 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500, false);
    And and4 = (And) FilterFactory.and(gtEq4, ltEq4);

    GtEq<Integer> gtEq5 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, false);
    LtEq<Integer> ltEq5 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    ...
    // [600, 800] [400, 500]
    GtEq<Integer> gtEq6 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, true);
    LtEq<Integer> ltEq6 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, false);
    And and6 = (And) FilterFactory.and(gtEq6, ltEq6);

    GtEq<Integer> gtEq7 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400, false);
    LtEq<Integer> ltEq8 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500, true);
  ...
  public void notEqTest() {
    NotEq<Integer> notEq = FilterFactory.noteq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000);
  ...
  public void orTest() {
    ...
    GtEq<Integer> gtEq_11 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470, true);
    LtEq<Integer> ltEq_11 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200, false);
    And and1 = (And) FilterFactory.and(gtEq_11, ltEq_11);

    GtEq<Integer> gtEq_12 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500, false);
    LtEq<Integer> ltEq_12 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    And and2 = (And) FilterFactory.and(gtEq_12, ltEq_12);

    GtEq<Integer> gtEq_13 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000, true);
    LtEq<Integer> ltEq_l3 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000, false);
    And and3 = (And) FilterFactory.and(gtEq_13, ltEq_l3);

    GtEq<Integer> gtEq_14 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 100, true);
    LtEq<Integer> ltEq_14 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 200, true);
  ...
  public void additionTest() {
    ...
    GtEq<Integer> gtEq_11 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 4000, true);
    LtEq<Integer> ltEq_11 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 4500, false);
    And and1 = (And) FilterFactory.and(gtEq_11, ltEq_11);
  ...
  public void notOperatorTest() {
    ...
    GtEq<Integer> gtEq_11 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 30, true);
    LtEq<Integer> ltEq_11 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, false);
    // GtEq<Integer> gtEq_112 = FilterApi.gtEq(FilterApi.intFilterSeries(deltaObjectUID,
    // measurementUID, FilterSeriesType.VALUE_FILTER), 600, true);
    // LtEq<Integer> ltEq_112 = FilterApi.ltEq(FilterApi.intFilterSeries(deltaObjectUID,
    // measurementUID, FilterSeriesType.VALUE_FILTER), 30, false);
    And and1 = (And) FilterFactory.and(gtEq_11, ltEq_11);
    ...
    LtEq<Integer> ltEq_12 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    // GtEq<Integer> gtEq_122 = FilterApi.gtEq(FilterApi.intFilterSeries(deltaObjectUID,
    // measurementUID, FilterSeriesType.VALUE_FILTER), 800, false);
    // LtEq<Integer> ltEq_122 = FilterApi.ltEq(FilterApi.intFilterSeries(deltaObjectUID,
    // measurementUID, FilterSeriesType.VALUE_FILTER), 500, true);
    And and2 = (And) FilterFactory.and(gtEq_12, ltEq_12);
  ...
  public void minMaxValueTest() {
    ...
    GtEq<Integer> gtEq1 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), Integer.MAX_VALUE, true);
    ...
    GtEq<Integer> gtEq2 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), Integer.MAX_VALUE, false);
    ...
    LtEq<Integer> ltEq1 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), Integer.MIN_VALUE, true);
    ...
    LtEq<Integer> ltEq2 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), Integer.MIN_VALUE, false);
    ...
    NotEq<Integer> noteq = FilterFactory.noteq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), Integer.MIN_VALUE);
    ...
    NotEq<Integer> noteq2 = FilterFactory.noteq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), Integer.MAX_VALUE);
  ...
  public void unionBugTest() {
    ...
    GtEq<Integer> gtEq2 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 200, false);
    LtEq<Integer> ltEq2 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 300, true);
    And and2 = (And) FilterFactory.and(gtEq2, ltEq2);

    GtEq<Integer> gtEq3 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 350, false);
    LtEq<Integer> ltEq3 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400, true);
    And and3 = (And) FilterFactory.and(gtEq3, ltEq3);
    Or o1 = (Or) FilterFactory.or(and2, and3);
  ...
  public void unionCoverageTest() {
    ...
    GtEq<Integer> gtEq4 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 200, false);
    LtEq<Integer> ltEq4 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1600, true);
    And and4 = (And) FilterFactory.and(gtEq4, ltEq4);

    Or o2 = (Or) FilterFactory.or(and3, and4);
    IntInterval ans2 = (IntInterval) new IntFilterVerifier().getInterval(o2);
    // System.out.println(ans2);
    assertEquals(ans2.v[0], 200);
    assertEquals(ans2.flag[0], false);
    assertEquals(ans2.v[1], 1600);
    assertEquals(ans2.flag[1], true);

    // right first cross (2)
    GtEq<Integer> gtEq5 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 700, true);
    LtEq<Integer> ltEq5 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, false);
    And and5 = (And) FilterFactory.and(gtEq5, ltEq5);
    ...
    assertEquals(ans3.v[0], 200);
    assertEquals(ans3.flag[0], false);
    assertEquals(ans3.v[1], 800);
    assertEquals(ans3.flag[1], true);

    // left first cross (2)
    GtEq<Integer> gtEq7 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 200, true);
    LtEq<Integer> ltEq7 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, false);
    And and7 = (And) FilterFactory.and(gtEq7, ltEq7);

    GtEq<Integer> gtEq8 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 700, false);
    LtEq<Integer> ltEq8 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    ...
    assertEquals(ans4.v[0], 200);
    assertEquals(ans4.flag[0], true);
    assertEquals(ans4.v[1], 800);
    assertEquals(ans4.flag[1], true);

    // right first
    GtEq<Integer> gtEq9 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, true);
    LtEq<Integer> ltEq9 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    And and9 = (And) FilterFactory.and(gtEq9, ltEq9);

    GtEq<Integer> gtEq10 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, false);
    LtEq<Integer> ltEq10 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 700, true);
    ...
    System.out.println(ans4);
    assertEquals(ans5.v[0], 600);
    assertEquals(ans5.flag[0], true);
    assertEquals(ans5.v[1], 800);
    assertEquals(ans5.flag[1], true);

    // left first cross (1)
    GtEq<Integer> gtEq11 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, true);
    LtEq<Integer> ltEq11 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 700, true);
    And and11 = (And) FilterFactory.and(gtEq11, ltEq11);

    GtEq<Integer> gtEq12 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600, false);
    LtEq<Integer> ltEq12 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800, true);
    ...
    System.out.println(ans4);
    assertEquals(ans6.v[0], 600);
    assertEquals(ans6.flag[0], true);
    assertEquals(ans6.v[1], 800);
    assertEquals(ans6.flag[1], true);
  }
  ...
  public void andOrBorderTest() {
    ...
    // And Operator
    GtEq<Integer> gtEq1 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2, false);
    LtEq<Integer> ltEq1 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2, false);
    And and1 = (And) FilterFactory.and(gtEq1, ltEq1);
    ...
    gtEq1 = FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 2, true);
    ltEq1 = FilterFactory.ltEq(FilterFactory.intFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 2, false);
    ...
    assertEquals(ans.v[0], Integer.MIN_VALUE);
    assertEquals(ans.flag[0], true);
    assertEquals(ans.v[1], 2L);
    assertEquals(ans.flag[1], false);
    assertEquals(ans.v[2], 2L);
    assertEquals(ans.flag[2], false);
    assertEquals(ans.v[3], Integer.MAX_VALUE);
    assertEquals(ans.flag[3], true);
    ...
    assertEquals(ans.v[0], Integer.MIN_VALUE);
    assertEquals(ans.flag[0], true);
    assertEquals(ans.v[1], Integer.MAX_VALUE);
    assertEquals(ans.flag[1], true);
    or1 = (Or) FilterFactory.or(ltEq1, gtEq1);
    ans = (IntInterval) new IntFilterVerifier().getInterval(or1);
    assertEquals(ans.count, 2);
