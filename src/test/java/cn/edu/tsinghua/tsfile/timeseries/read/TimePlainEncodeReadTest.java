...
public class TimePlainEncodeReadTest {
  ...
  private static QueryConfig configWithTwoSeriesTimeValueNoCrossFilter = new QueryConfig(
      "d2.s1|d2.s4", "0,(>=1480562618970)&(<1480562618977)", "null", "2,d2.s2,(>9722)");
  private static QueryConfig configWithTwoSeriesTimeValueNoCrossFilter2 =
      new QueryConfig("d2.s2", "0,(>=1480562618970)&(<1480562618977)", "null", "2,d2.s2,(!=9722)");

  private static QueryConfig configWithTwoSeriesTimeValueCrossFilter = new QueryConfig(
      "d1.s1|d2.s2", "0,(>=1480562618970)&(<1480562618977)", "null", "[2,d2.s2,(>9722)]");

  private static QueryConfig configWithCrossSeriesTimeValueFilter =
      new QueryConfig("d1.s1|d2.s2", "0,(>=1480562618950)&(<=1480562618960)", "null",
          "[2,d2.s3,(>9541)|(<=9511)]&[2,d1.s1,(<=9562)]");

  private static QueryConfig configWithCrossSeriesTimeValueFilterOrOpe =
      new QueryConfig("d1.s1|d2.s2",
          "0,((>=1480562618906)&(<=1480562618915))|((>=1480562618928)&(<=1480562618933))", "null",
          "[2,d1.s1,(<=9321)]|[2,d2.s2,(>9312)]");

  private static QueryConfig booleanConfig =
      new QueryConfig("d1.s5", "0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s5,(=false)");

  private static QueryConfig greatStringConfig =
      new QueryConfig("d1.s4", "0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s4,(>dog97)");

  private static QueryConfig lessStringConfig =
      new QueryConfig("d1.s4", "0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s4,(<dog97)");

  private static QueryConfig floatConfig =
      new QueryConfig("d1.s6", "0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s6,(>103.0)");

  private static QueryConfig doubleConfig =
      new QueryConfig("d1.s7", "0,(>=1480562618021)&(<=1480562618033)", "null", "2,d1.s7,(<=7.0)");

  private static QueryConfig floatDoubleConfigFilter =
      new QueryConfig("d1.s6", "0,(>=1480562618005)&(<1480562618977)", "null", "2,d1.s6,(>=103.0)");
  ...
  public void queryOneMeasurementWithoutFilterTest() throws IOException {
    OnePassQueryDataSet onePassQueryDataSet =
        QueryEngine.query(configOneSeriesWithNoFilter, fileName);
  ...
  public void queryTwoMeasurementsWithoutFilterTest() throws IOException {
    OnePassQueryDataSet onePassQueryDataSet =
        QueryEngine.query(configTwoSeriesWithNoFilter, fileName);
    int count = 0;
    while (onePassQueryDataSet.hasNextRecord()) {
      OldRowRecord r = onePassQueryDataSet.getNextRecord();
      if (count == 0) {
  ...
  public void queryTwoMeasurementsWithSingleFilterTest() throws IOException {
    OnePassQueryDataSet onePassQueryDataSet =
        QueryEngine.query(configWithTwoSeriesTimeValueNoCrossFilter2, fileName);
  ...
  public void queryWithTwoSeriesTimeValueFilterCrossTest() throws IOException {
    OnePassQueryDataSet onePassQueryDataSet =
        QueryEngine.query(configWithTwoSeriesTimeValueCrossFilter, fileName);
  ...
  public void queryWithCrossSeriesTimeValueFilterTest() throws IOException {
    OnePassQueryDataSet onePassQueryDataSet =
        QueryEngine.query(configWithCrossSeriesTimeValueFilter, fileName);
    // time filter & value filter
    // verify d1.s1, d2.s1
    /**
    ...
    OnePassQueryDataSet onePassQueryDataSetOrOpe =
        QueryEngine.query(configWithCrossSeriesTimeValueFilterOrOpe, fileName);
    // time filter & value filter
    // verify d1.s1, d2.s1
    /**
