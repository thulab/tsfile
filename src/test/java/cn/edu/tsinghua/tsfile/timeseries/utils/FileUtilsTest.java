...
public class FileUtilsTest {
  ...
  public void testConvertUnit() {
    ...
    assertEquals(3, FileUtils.transformUnit(kb, Unit.KB), TimeseriesTestConstant.double_min_delta);

    assertEquals(3, FileUtils.transformUnit(mb, Unit.MB), TimeseriesTestConstant.double_min_delta);
    assertEquals(3, FileUtils.transformUnit(gb, Unit.GB), TimeseriesTestConstant.double_min_delta);
  }
