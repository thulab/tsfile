...
public class FilterVerifierDoubleTest {
  ...
  @Test
  public void eqTest() {
    Eq<Double> eq = FilterFactory.eq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 45.0);
  ...
  public void ltEqTest() {
    LtEq<Double> ltEq = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 45.0, true);
    ...
    ltEq = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), -45.0, true);
  ...
  public void andOrTest() {
    ...
    GtEq<Double> gtEq1 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470.0, true);
    LtEq<Double> ltEq1 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200.0, false);
    And and1 = (And) FilterFactory.and(gtEq1, ltEq1);

    GtEq<Double> gtEq2 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500.0, false);
    LtEq<Double> ltEq2 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800.0, true);
    And and2 = (And) FilterFactory.and(gtEq2, ltEq2);

    GtEq<Double> gtEq3 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000.0, true);
    LtEq<Double> ltEq3 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000.0, false);
    ...
    // [400, 500) (600, 800]
    GtEq<Double> gtEq4 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400.0, true);
    LtEq<Double> ltEq4 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500.0, false);
    And and4 = (And) FilterFactory.and(gtEq4, ltEq4);

    GtEq<Double> gtEq5 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600.0, false);
    LtEq<Double> ltEq5 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800.0, true);
    ...
    // [600, 800] [400, 500]
    GtEq<Double> gtEq6 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 600.0, true);
    LtEq<Double> ltEq6 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800.0, false);
    And and6 = (And) FilterFactory.and(gtEq6, ltEq6);

    GtEq<Double> gtEq7 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 400.0, false);
    LtEq<Double> ltEq8 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500.0, true);
  ...
  public void notEqTest() {
    NotEq<Double> notEq = FilterFactory.noteq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000.0);
  ...
  public void orTest() {
    ...
    GtEq<Double> gtEq_11 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470.0, true);
    LtEq<Double> ltEq_11 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200.0, false);
    And and1 = (And) FilterFactory.and(gtEq_11, ltEq_11);

    GtEq<Double> gtEq_12 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 500.0, false);
    LtEq<Double> ltEq_12 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800.0, true);
    And and2 = (And) FilterFactory.and(gtEq_12, ltEq_12);

    GtEq<Double> gtEq_13 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000.0, true);
    LtEq<Double> ltEq_l3 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000.0, false);
    And and3 = (And) FilterFactory.and(gtEq_13, ltEq_l3);

    GtEq<Double> gtEq_14 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 100.0, true);
    LtEq<Double> ltEq_14 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 200.0, true);
  ...
  public void orborderTest() {
    ...
    GtEq<Double> gtEq_11 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 470.0, true);
    LtEq<Double> ltEq_11 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200.0, true);
    And and1 = (And) FilterFactory.and(gtEq_11, ltEq_11);

    GtEq<Double> gtEq_12 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1200.0, true);
    LtEq<Double> ltEq_12 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1500.0, true);
    And and2 = (And) FilterFactory.and(gtEq_12, ltEq_12);

    GtEq<Double> gtEq_13 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000.0, false);
    LtEq<Double> ltEq_l3 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000.0, false);
    And and3 = (And) FilterFactory.and(gtEq_13, ltEq_l3);
    ...
    GtEq<Double> gtEq_16 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000.0, false);
    LtEq<Double> ltEq_l6 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000.0, false);
    And and6 = (And) FilterFactory.and(gtEq_16, ltEq_l6);
    GtEq<Double> gtEq_17 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800.0, true);
    LtEq<Double> ltEq_17 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1000.0, true);
    ...
    GtEq<Double> gtEq_18 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 1800.0, false);
    LtEq<Double> ltEq_l8 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2000.0, false);
    And and8 = (And) FilterFactory.and(gtEq_18, ltEq_l8);
    GtEq<Double> gtEq_19 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 800.0, true);
    LtEq<Double> ltEq_19 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 3000.0, true);
  ...
  public void bugTest2() {
    ...
    GtEq<Double> gtEq_12 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 20.0, true);
    LtEq<Double> ltEq_12 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 100.0, true);
    And and2 = (And) FilterFactory.and(gtEq_12, ltEq_12);
  ...
  public void andOrBorderTest() {
    ...
    // And Operator
    GtEq<Double> gtEq1 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2.0, false);
    LtEq<Double> ltEq1 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID,
        measurementUID, FilterSeriesType.VALUE_FILTER), 2.0, false);
    And and1 = (And) FilterFactory.and(gtEq1, ltEq1);
    ...
    gtEq1 = FilterFactory.gtEq(FilterFactory.doubleFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 2.0, true);
    ltEq1 = FilterFactory.ltEq(FilterFactory.doubleFilterSeries(deltaObjectUID, measurementUID,
        FilterSeriesType.VALUE_FILTER), 2.0, false);
    ...
    assertEquals(ans.count, 4);
    assertEquals(ans.v[0], -Double.MAX_VALUE, theta);
    assertEquals(ans.flag[0], true);
    assertEquals(ans.v[1], 2L, theta);
    assertEquals(ans.flag[1], false);
    assertEquals(ans.v[2], 2L, theta);
    assertEquals(ans.flag[2], false);
    assertEquals(ans.v[3], Double.MAX_VALUE, theta);
    assertEquals(ans.flag[3], true);
    ...
    assertEquals(ans.v[0], -Double.MAX_VALUE, theta);
    assertEquals(ans.flag[0], true);
    assertEquals(ans.v[1], Double.MAX_VALUE, theta);
    assertEquals(ans.flag[1], true);
    or1 = (Or) FilterFactory.or(ltEq1, gtEq1);
    ans = (DoubleInterval) new DoubleFilterVerifier().getInterval(or1);
    assertEquals(ans.count, 2);
