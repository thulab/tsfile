...
public class QueryEngineTest {
  ...
  public static void setUpBeforeClass()
      throws InterruptedException, WriteProcessException, IOException {
  ...
  public void readAllInOneColumn() {
    QueryConfig config =
        new QueryConfig("root.vehicle.d1.s1|root.vehicle.d1.s2|root.vehicle.d1.s3");
    try {
  ...
  public void readOneColumnWithTimeFilter() {
    QueryConfig config = new QueryConfig("root.vehicle.d1.s1|root.vehicle.d1.s2",
        "0,(>178)&(<=198)", "null", "null");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
  ...
  public void readOneColumnWithValueFilter() {
    QueryConfig config =
        new QueryConfig("root.vehicle.d1.s1", "null", "null", "2,root.vehicle.d1.s1,(>=18901)");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
  ...
  public void readOneColumnWithTimeAndValueFilter1() {
    QueryConfig config = new QueryConfig("root.vehicle.d1.s1", "0,(>278)&(<=298)", "null",
        "2,root.vehicle.d1.s1,(>10294)");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
  ...
  public void readOneColumnWithTimeAndValueFilter2() {
    QueryConfig config =
        new QueryConfig("root.vehicle.d1.s1", "0,(>=186)", "null", "2,root.vehicle.d1.s1,(>10211)");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
  ...
  public void crossRead1() {
    QueryConfig config = new QueryConfig("root.vehicle.d1.s1|root.vehicle.d1.s2", "0,(<=197)",
        "null", "[2,root.vehicle.d1.s1,(<10)]");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
  ...
  public void crossRead2() {
    QueryConfig config = new QueryConfig("root.vehicle.d1.s1|root.vehicle.d1.s2", "0,(>=0)", "null",
        "[2,root.vehicle.d1.s2,(>17802)]");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
  ...
  public void crossRead3() {
    QueryConfig config =
        new QueryConfig("root.vehicle.d1.s1|root.vehicle.d1.s2|root.vehicle.d1.s3", "0,(<=190)",
            "null", "[2,root.vehicle.d1.s2,(>17802)]&[2,root.vehicle.d1.s3,(>18703)&(<18903)]");
    try {
      OnePassQueryDataSet res = engine.query(config);
      int count = output(res, true);
