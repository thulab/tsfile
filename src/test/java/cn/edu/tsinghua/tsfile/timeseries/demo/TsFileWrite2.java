...
public class TsFileWrite2 {
  ...
  public static void main(String args[]) {
    try {
      ...
      // add measurements
      tsFileWriter
          .addMeasurement(new MeasurementDescriptor("sensor_1", TSDataType.FLOAT, TSEncoding.RLE));
      tsFileWriter.addMeasurement(
          new MeasurementDescriptor("sensor_2", TSDataType.INT32, TSEncoding.TS_2DIFF));
      tsFileWriter.addMeasurement(
          new MeasurementDescriptor("sensor_3", TSDataType.INT32, TSEncoding.TS_2DIFF));
