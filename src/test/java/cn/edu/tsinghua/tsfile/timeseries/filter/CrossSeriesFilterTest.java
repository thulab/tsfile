...
public class CrossSeriesFilterTest {
	...
	public void testCrossSeriesFilterApi() {
		...
		Assert.assertEquals(csand.getLeft(), left);
		Assert.assertEquals(csand.getRight(), right);
		...
		Assert.assertEquals(csor.getLeft(), left);
		Assert.assertEquals(csor.getRight(), right);
