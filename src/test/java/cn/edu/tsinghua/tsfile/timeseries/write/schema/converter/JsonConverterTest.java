...
public class JsonConverterTest {
  ...
  public void testJsonConverter() throws WriteProcessException {
    ...
    String[] measureDesStrings = {"[,s3,ENUMS,BITMAP,,SNAPPY,[MAN, WOMAN],]",
    ...
    Collections.sort(tsMetadataList,
        (x, y) -> x.getMeasurementUID().compareTo(y.getMeasurementUID()));
  ...
  public void testConvertInJsonAndFileSchema() throws InvalidJsonSchemaException {
    ...
    for (int i = 0; i < descSchemaArray.length(); i++) {
      ...
      descSchemaMap.put(descMeasureObj.getString(JsonFormatConstant.MEASUREMENT_UID),
          descMeasureObj);
    }
