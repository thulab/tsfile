...
public class Utils {
  ...
  public static void isDeltaObjectEqual(TsDeltaObject deltaObjectInTSF,
      DeltaObject deltaObjectInTHrift) {
    if (Utils.isTwoObjectsNotNULL(deltaObjectInTSF, deltaObjectInTHrift, "Delta object")) {
      ...
      assertTrue(
          deltaObjectInTSF.metadataBlockSize == deltaObjectInTHrift.getMetadata_block_size());
  ...
  public static void isRowGroupBlockMetadataEqual(
      TsRowGroupBlockMetaData rowGroupBlockMetaDataInTSF,
    ...
    if (Utils.isTwoObjectsNotNULL(rowGroupBlockMetaDataInTSF, rowGroupBlockMetaDataInThrift,
      ...
      if (Utils.isTwoObjectsNotNULL(rowGroupBlockMetaDataInTSF.getRowGroups(),
        ...
        List<cn.edu.tsinghua.tsfile.format.RowGroupMetaData> listThrift =
            rowGroupBlockMetaDataInThrift.getRow_groups_metadata();
        if (listTSF.size() != listThrift.size()) {
          fail("TimeSeriesGroupMetaData List size is different");
        }
        // long maxNumRows = 0;
        ...
        Utils.isStringSame(rowGroupBlockMetaDataInTSF.getDeltaObjectID(),
            rowGroupBlockMetaDataInThrift.getDelta_object_id(), "delta object id");
      }
    }
  }
  ...
  public static void isFileMetaDataEqual(TsFileMetaData fileMetaDataInTSF,
    ...
    if (Utils.isTwoObjectsNotNULL(fileMetaDataInTSF, fileMetaDataInThrift, "File MetaData")) {
      ...
      if (Utils.isTwoObjectsNotNULL(fileMetaDataInTSF.getProps(),
          fileMetaDataInThrift.getProperties(), "user specified properties")) {
        Utils.isMapStringEqual(fileMetaDataInTSF.getProps(), fileMetaDataInThrift.getProperties(),
            "Filemetadata properties");
      }
      if (Utils.isTwoObjectsNotNULL(fileMetaDataInTSF.getDeltaObjectMap(),
          fileMetaDataInThrift.getDelta_object_map(), "delta object map")) {
