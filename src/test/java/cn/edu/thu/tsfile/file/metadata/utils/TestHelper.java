package cn.edu.thu.tsfile.file.metadata.utils;
...
import cn.edu.thu.tsfile.file.metadata.RowGroupMetaDataTest;
import cn.edu.thu.tsfile.file.metadata.TInTimeSeriesChunkMetaData;
import cn.edu.thu.tsfile.file.metadata.TInTimeSeriesChunkMetaDataTest;
import cn.edu.thu.tsfile.file.metadata.TSDigest;
import cn.edu.thu.tsfile.file.metadata.TimeSeriesChunkMetaData;
import cn.edu.thu.tsfile.file.metadata.TimeSeriesChunkMetaDataTest;
import cn.edu.thu.tsfile.file.metadata.TimeSeriesMetadata;
import cn.edu.thu.tsfile.file.metadata.TimeSeriesMetadataTest;
import cn.edu.thu.tsfile.file.metadata.VInTimeSeriesChunkMetaData;
import cn.edu.thu.tsfile.file.metadata.VInTimeSeriesChunkMetaDataTest;
...
public class TestHelper {
  ...
  public static cn.edu.thu.tsfile.format.RowGroupMetaData createSimpleRowGroupMetaDataInThrift()
      throws UnsupportedEncodingException {
    cn.edu.thu.tsfile.format.RowGroupMetaData rowGroupMetaData =
        new cn.edu.thu.tsfile.format.RowGroupMetaData(new ArrayList<>(),
