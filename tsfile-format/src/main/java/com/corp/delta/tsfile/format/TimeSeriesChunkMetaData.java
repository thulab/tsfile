    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TimeSeriesChunkMetaData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TIMESERIES_CHUNK_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.timeseries_chunk_type = com.corp.delta.tsfile.format.TimeSeriesChunkType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem41 = com.corp.delta.tsfile.format.Encoding.findByValue(iprot.readI32());
          ...
          case 6: // COMPRESSION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.compression_type = com.corp.delta.tsfile.format.CompressionType.findByValue(iprot.readI32());
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            _elem51 = com.corp.delta.tsfile.format.Encoding.findByValue(iprot.readI32());
