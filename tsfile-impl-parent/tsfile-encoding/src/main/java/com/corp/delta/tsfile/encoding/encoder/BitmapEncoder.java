package com.corp.delta.tsfile.encoding.encoder;
...
public class BitmapEncoder extends Encoder {
   ...
   * @throws Exception
   * @see com.corp.delta.tsfile.encoding.encoder.Encoder#encode(int, java.io.ByteArrayOutputStream)
   */
  @Override
   ...
   * @param out OutputStream to write encoded stream
   * @throws IOException
   * @see com.corp.delta.tsfile.encoding.encoder.Encoder#flush(java.io.ByteArrayOutputStream)
   */
  @Override
