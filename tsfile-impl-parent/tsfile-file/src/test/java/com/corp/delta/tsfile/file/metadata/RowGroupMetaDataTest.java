...
public class RowGroupMetaDataTest {
  ...
  public void testWriteIntoFile() throws IOException {
    ...
    Utils.isRowGroupMetaDataEqual(metaData,
        Utils.read(fis, new com.corp.delta.tsfile.format.RowGroupMetaData()));
  }
  ...
  public void testConvertToTSF() throws UnsupportedEncodingException {
    com.corp.delta.tsfile.format.RowGroupMetaData rowGroupMetaData =
        new com.corp.delta.tsfile.format.RowGroupMetaData(null, DELTA_OBJECT_UID, TOTAL_BYTE_SIZE,
