...
public class TimeSeriesChunkMetaDataTest {
  ...
  public void testWriteIntoFile() throws IOException {
    ...
    Utils.isTimeSeriesChunkMetaDataEqual(metaData,
        Utils.read(fis, new com.corp.delta.tsfile.format.TimeSeriesChunkMetaData()));
  }
  ...
  public void testConvertToTSF() throws UnsupportedEncodingException {
    for (CompressionType compressionType : CompressionType.values()) {
      for (TimeSeriesChunkType chunkType : TimeSeriesChunkType.values()) {
        ...
        com.corp.delta.tsfile.format.TimeSeriesChunkMetaData timeSeriesChunkMetaData =
            new com.corp.delta.tsfile.format.TimeSeriesChunkMetaData(MEASUREMENT_UID, chunkType,
