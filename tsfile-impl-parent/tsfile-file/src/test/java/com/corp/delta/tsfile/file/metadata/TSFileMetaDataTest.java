...
import com.corp.delta.tsfile.file.metadata.utils.TestHelper;
...
public class TSFileMetaDataTest {
  ...
  public void testWriteFileMetaData() throws IOException {
    ...
    com.corp.delta.tsfile.format.FileMetaData fileMetaData2 =
  ...
  public void testCreateTSFMetadata() throws UnsupportedEncodingException {
    ...
    fileMetaData.setTimeseries_list(new ArrayList<com.corp.delta.tsfile.format.TimeSeries>());
    Utils.isFileMetaDataEqual(converter.toTSFileMetadata(fileMetaData), fileMetaData);
    ...
    fileMetaData.setRow_groups(new ArrayList<com.corp.delta.tsfile.format.RowGroupMetaData>());
    Utils.isFileMetaDataEqual(converter.toTSFileMetadata(fileMetaData), fileMetaData);

    com.corp.delta.tsfile.format.RowGroupMetaData rowGroupMetaData1 =
    ...
    com.corp.delta.tsfile.format.RowGroupMetaData rowGroupMetaData2 =
        TestHelper.createSimpleRowGroupMetaDataInThrift();
