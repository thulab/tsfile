package com.corp.delta.tsfile.file.metadata.converter;
...
public class TSFileMetaDataConverter {
   ...
   *              com.corp.delta.tsfile.format.FileMetaData in tsfile-format project
   ...
   *              information about thrift format file matadata, see
   *              com.corp.delta.tsfile.format.FileMetaData in tsfile-format
