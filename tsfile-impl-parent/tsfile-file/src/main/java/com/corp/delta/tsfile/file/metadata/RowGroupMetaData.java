...
/**
 * @Description For more information, see com.corp.delta.tsfile.format.RowGroupMetaData in
 *              tsfile-format
 * @author XuYi xuyi556677@163.com
 * @date Apr 29, 2016 9:57:59 PM
 */
public class RowGroupMetaData implements IConverter<com.corp.delta.tsfile.format.RowGroupMetaData> {
   ...
   */
  @Override
  public com.corp.delta.tsfile.format.RowGroupMetaData convertToThrift() {
    try {
      List<com.corp.delta.tsfile.format.TimeSeriesChunkMetaData> timeSeriesChunkMetaDataListInThrift = null;
      if (timeSeriesChunkMetaDataList != null) {
      ...
      com.corp.delta.tsfile.format.RowGroupMetaData metaDataInThrift =
          new com.corp.delta.tsfile.format.RowGroupMetaData(timeSeriesChunkMetaDataListInThrift,
   ...
   */
  @Override
  public void convertToTSF(com.corp.delta.tsfile.format.RowGroupMetaData metaDataInThrift) {
    try {
      ...
      List<com.corp.delta.tsfile.format.TimeSeriesChunkMetaData> timeSeriesChunkMetaDataListInThrift = metaDataInThrift.getTsc_metadata();
      if (timeSeriesChunkMetaDataListInThrift == null) {
        ...
        for (com.corp.delta.tsfile.format.TimeSeriesChunkMetaData timeSeriesChunkMetaDataInThrift : timeSeriesChunkMetaDataListInThrift) {
