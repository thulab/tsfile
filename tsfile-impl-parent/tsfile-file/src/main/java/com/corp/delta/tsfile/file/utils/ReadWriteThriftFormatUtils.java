package com.corp.delta.tsfile.file.utils;
...
import com.corp.delta.tsfile.format.DataPageHeader;
import com.corp.delta.tsfile.format.DictionaryPageHeader;
import com.corp.delta.tsfile.format.Digest;
import com.corp.delta.tsfile.format.Encoding;
import com.corp.delta.tsfile.format.FileMetaData;
import com.corp.delta.tsfile.format.PageHeader;
import com.corp.delta.tsfile.format.PageType;
...
public class ReadWriteThriftFormatUtils {
   ...
   *              see com.corp.delta.tsfile.format.PageHeader and
   *              com.corp.delta.tsfile.format.DataPageHeader in tsfile-format
   * @return void
   * @throws IOException
   */
   ...
   *                    PageHeader and DataPageHeader, see com.corp.delta.tsfile.format.PageHeader
   *                    and com.corp.delta.tsfile.format.DataPageHeader in tsfile-format
   * @return PageHeader
   */
   ...
   *              DictionaryPageHeader, see com.corp.delta.tsfile.format.PageHeader and
   *              com.corp.delta.tsfile.format.DictionaryPageHeader in tsfile-format. 
