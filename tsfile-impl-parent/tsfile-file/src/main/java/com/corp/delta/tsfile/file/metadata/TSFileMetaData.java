...
public class TSFileMetaData implements IConverter<FileMetaData> {
   ...
   *              thrift format, see com.corp.delta.tsfile.format.FileMetaData in tsfile-format
  ...
  public FileMetaData convertToThrift() {
    try {
      ...
      long numOfRows = 0;
      List<com.corp.delta.tsfile.format.RowGroupMetaData> rowGroupMetaDataListInThrift = null;
      if (rowGroupMetadataList != null) {
        rowGroupMetaDataListInThrift =
            new ArrayList<com.corp.delta.tsfile.format.RowGroupMetaData>();
  ...
  public void convertToTSF(FileMetaData metadataInThrift) {
    try {
      ...
      List<com.corp.delta.tsfile.format.RowGroupMetaData> rowGroupMetaDataListInThrift =
          metadataInThrift.getRow_groups();
      if (rowGroupMetaDataListInThrift == null) {
        rowGroupMetadataList = null;
      } else {
        rowGroupMetadataList = new ArrayList<RowGroupMetaData>();
        for (com.corp.delta.tsfile.format.RowGroupMetaData rowGroupMetaDataInThrift : rowGroupMetaDataListInThrift) {
