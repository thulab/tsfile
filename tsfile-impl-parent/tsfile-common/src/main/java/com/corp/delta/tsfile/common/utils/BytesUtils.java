package com.corp.delta.tsfile.common.utils;
...
public class BytesUtils {
   ...
   * 
   * @param num :Long variable to be converted
   * @param len : the length of result byte array
   ...
   * @param len : the length of input byte array to be convert
   * @return byte array which length equals with parameter len
   */
  ...
  /**
   * get one bit in input long. the offset is from low to high and start with 0<br>
   * 
   * @param data
   * @param offset
   * @return
  ...
  /**
   * set one bit in input long. the offset is from low to high and start with index 0<br>
   * 
   * @param data
   * @param offset
   * @param value
   ...
   * 
   * @param result
   * @param pos - not byte offset, but bit offset
   * @param width
   * @return
   */
