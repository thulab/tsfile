package com.corp.delta.tsfile.common.utils.bytesinput;
...
public class ListBytesInputTest {
    ...
    public void testAppendBytesInput() {
        try {
            PublicBAOS pb1 = new PublicBAOS(b1);
            BytesInput bi1 = BytesInput.from(pb1);
            PublicBAOS pb2 = new PublicBAOS(b2);
            BytesInput bi2 = new ListBytesInput(pb2);
            PublicBAOS pb3 = new PublicBAOS(b3);
            BytesInput bi3 = BytesInput.from(pb3);
            PublicBAOS pb4;

            pb4 = new PublicBAOS(b4);
    ...
    public void testErrorException() {
        PublicBAOS pb1 = null, pb2 = null, pb3 = null;
        try {
            pb1 = new PublicBAOS(b1);
            pb2 = new PublicBAOS(b2);
            pb3 = new PublicBAOS(b3);
        } catch (IOException e) {
            fail();
        }
    ...
    public void testAppendPublicBAOS() {
        try {
            ...
            PublicBAOS pb4 = new PublicBAOS(b4);
