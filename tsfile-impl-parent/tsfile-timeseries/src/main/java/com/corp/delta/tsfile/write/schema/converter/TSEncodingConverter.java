...
import com.corp.delta.tsfile.common.exception.UnSupportedDataTypeException;
import com.corp.delta.tsfile.utils.StringContainer;
...
import com.corp.delta.tsfile.encoding.encoder.BitmapEncoder;
import com.corp.delta.tsfile.encoding.encoder.DeltaBinaryEncoder;
import com.corp.delta.tsfile.encoding.encoder.Encoder;
import com.corp.delta.tsfile.encoding.encoder.FloatEncoder;
import com.corp.delta.tsfile.encoding.encoder.IntRleEncoder;
import com.corp.delta.tsfile.encoding.encoder.LongRleEncoder;
import com.corp.delta.tsfile.encoding.encoder.PlainEncoder;
import com.corp.delta.tsfile.encoding.encoder.dft.DFTDoubleEncoder;
import com.corp.delta.tsfile.encoding.encoder.dft.DFTEncoder;
import com.corp.delta.tsfile.encoding.encoder.dft.DFTFloatEncoder;
import com.corp.delta.tsfile.encoding.encoder.dft.DFTIntEncoder;
import com.corp.delta.tsfile.encoding.encoder.dft.DFTLongEncoder;
...
import static com.corp.delta.tsfile.file.metadata.enums.TSDataType.ENUMS;

/**
 * Each subclass of TSEncodingConverter responds a enumerate value in
 * {@linkplain com.corp.delta.tsfile.file.metadata.enums.TSEncoding TSEncoding}, which stores several
 * configuration related to responding encoding type to generate
 * {@linkplain com.corp.delta.tsfile.encoding.encoder.Encoder Encoder} instance.<br>
...
public abstract class TSEncodingConverter {
     ...
     * @return - return a {@linkplain com.corp.delta.tsfile.encoding.encoder.Encoder Encoder}
     */
