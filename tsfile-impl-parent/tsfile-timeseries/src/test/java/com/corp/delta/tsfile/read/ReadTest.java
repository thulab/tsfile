...
import com.corp.delta.tsfile.read.query.DynamicOneColumnData;
...
public class ReadTest {
	...
	static LocalFileInput inputFile;
	static QueryEngine engine = null;
	static TSRandomAccessFileReader raf;
	static QueryConfig configOneSeriesWithNoFilter = new QueryConfig("d1.s1");
	
	static QueryConfig configTwoSeriesWithNoFilter = new QueryConfig("d1.s1|d2.s2");
	
	static QueryConfig configWithTwoSeriesTimeValueNoCrossFilter = new QueryConfig("d2.s1|d2.s4",
			"0,(>=1480562618970)&(<1480562618977)", "null", "2,d2.s2,(>9722)");
	static QueryConfig configWithTwoSeriesTimeValueNoCrossFilter2 = new QueryConfig("d2.s2",
			"0,(>=1480562618970)&(<1480562618977)", "null", "2,d2.s2,(!=9722)");
	
	static QueryConfig configWithTwoSeriesTimeValueCrossFilter = new QueryConfig("d1.s1|d2.s2",
			"0,(>=1480562618970)&(<1480562618977)", "null", "[2,d2.s2,(>9722)]");
	
	static QueryConfig configWithCrossSeriesTimeValueFilter = new QueryConfig("d1.s1|d2.s2",
			"0,(>=1480562618950)&(<=1480562618960)", "null", "[2,d2.s3,(>9541)|(<=9511)]&[2,d1.s1,(<=9562)]");
	
	static QueryConfig configWithCrossSeriesTimeValueFilterOrOpe = new QueryConfig("d1.s1|d2.s2",
			"0,((>=1480562618906)&(<=1480562618915))|((>=1480562618928)&(<=1480562618933))", "null",
			"[2,d1.s1,(<=9321)]|[2,d2.s2,(>9312)]");
	
	static QueryConfig booleanConfig = new QueryConfig("d1.s5",
			"0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s5,(=false)");
	
	static QueryConfig stringConfig = new QueryConfig("d1.s4",
			"0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s4,(=dog976)");
	
	static QueryConfig floatConfig = new QueryConfig("d1.s6",
			"0,(>=1480562618970)&(<=1480562618981)", "null", "2,d1.s6,(>103.0)");
	
	static QueryConfig doubleConfig = new QueryConfig("d1.s7",
			"0,(>=1480562618021)&(<=1480562618033)", "null", "2,d1.s7,(<=7.0)");
	
	static QueryConfig floatDoubleConfigFilter = new QueryConfig("d1.s6",
