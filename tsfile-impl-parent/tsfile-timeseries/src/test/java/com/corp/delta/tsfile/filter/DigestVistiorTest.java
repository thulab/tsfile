...
import static com.corp.delta.tsfile.filter.definition.FilterFactory.not;
...
public class DigestVistiorTest {
    ...
    @Test
    public void testNot() {
        Not not = (Not) not(FilterFactory.gtEq(FilterFactory.intFilterSeries(deltaObjectUID, measurementUID, FilterSeriesType.VALUE_FILTER), 990, true));
