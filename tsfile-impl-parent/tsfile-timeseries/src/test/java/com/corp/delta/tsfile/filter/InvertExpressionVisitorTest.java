...
import static com.corp.delta.tsfile.filter.definition.FilterFactory.and;
...
import com.corp.delta.tsfile.filter.definition.operators.SingleUnaryExpression;
import com.corp.delta.tsfile.filter.visitorImpl.InvertExpressionVisitor;
...
public class InvertExpressionVisitorTest {
    ...
    public void testInvertBinaryOperator() {
        ...
        FilterExpression complex = and(eqQ, and(ltEqQ, and(gtEqQ, notEqQ)));
