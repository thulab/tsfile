...
import com.corp.delta.tsfile.filter.utils.DoubleInterval;
import com.corp.delta.tsfile.filter.verifier.DoubleFilterVerifier;
...
public class FilterVerifierDoubleTest {
    ...
    public void ltEqTest() {
        ...
        assertEquals(x.count, 2);
        assertEquals(x.v[0], Double.MIN_VALUE, double_min_delta);
    ...
    public void notEqTest() {
        ...
        assertEquals(ans.count, 4);
        assertEquals(ans.v[0], Double.MIN_VALUE, double_min_delta);
